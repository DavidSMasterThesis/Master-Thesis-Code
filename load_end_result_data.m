...
set(gca,'xtick',1:2,'xticklabel',{'Within','Across'}), axis square, grid on
title('Prediction Error'), xlabel('Model'), ylabel('MSE')

% Plot test accuracy
subplot(1,2,2), bar(1,avg_cor_within), hold on, bar(2,avg_cor_across), hold off
set(gca,'xtick',1:2,'xticklabel',{'Within','Across'}), ylim([0 0.01]), axis square, grid on
